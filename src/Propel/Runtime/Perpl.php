...
/**
 * User access to Perpl global configuration and service container.
 */
class Perpl
{
    /**
    ...
    private static ServiceContainerInterface|null $serviceContainer = null;
     ...
     * {@link Perpl::getServiceContainer()}
     *
    ...
    public static function getStandardServiceContainer(): StandardServiceContainer
    {
        ...
        throw new PropelException('Instance was configured to not use StandardServiceContainer. Use Perpl::getServiceContainer()');
    }
    ...
    public static function log(string $message, int $level = self::LOG_DEBUG): void
    {
        ...
        match ($level) {
            self::LOG_EMERG => $logger->emergency($message),
            self::LOG_ALERT => $logger->alert($message),
            self::LOG_CRIT => $logger->critical($message),
            self::LOG_ERR => $logger->error($message),
...
*/
class_alias(Perpl::class, Propel::class);
